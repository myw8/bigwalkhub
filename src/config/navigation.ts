...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  ...
  { key: 'walkthrough', path: '/walkthrough', icon: 'lucide:route', isContentType: true, order: 2 },
  { key: 'puzzles', path: '/puzzles', icon: 'lucide:brain', isContentType: true, order: 3 },
  { key: 'map', path: '/map', icon: 'lucide:map', isContentType: true, order: 4 },
  { key: 'achievements', path: '/achievements', icon: 'lucide:medal', isContentType: true, order: 5 },
  { key: 'trophies', path: '/trophies', icon: 'lucide:trophy', isContentType: true, order: 6 },
  { key: 'platforms', path: '/platforms', icon: 'lucide:monitor', isContentType: true, order: 7 },
  { key: 'multiplayer', path: '/multiplayer', icon: 'lucide:users', isContentType: true, order: 8 },
  { key: 'crossplay', path: '/crossplay', icon: 'lucide:network', isContentType: true, order: 9 },
  { key: 'items', path: '/items', icon: 'lucide:package', isContentType: true, order: 10 },
  { key: 'endings', path: '/endings', icon: 'lucide:flag', isContentType: true, order: 11 },
];
